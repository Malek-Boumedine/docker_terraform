...
API_ADDRESS = os.getenv("API_ADDRESS", "https://localhost:8080/")
...
def account_activation(email : str, new_password : str, confirm_password : str) : 
    url = f"{API_ADDRESS}auth/activation/{email}"
...
def loan_request_to_api(donnees : dict) : 
    ...
    try : 
        url = f"{API_ADDRESS}loans/request"
